...
def single_session_analysis(animal_dir, signal_filename, arduino_filename, behav_filename):
    ...
    #         'exp_entry', 'exp_exit')
    #
    #     func.sensor_raster_plot(dFF0, pi_events, pi_trials, condition,
    #                        branch=b,
    #                        port='exp',
    #                        aligned_by='rewards',
    #                        sequence=0,
    ...
    transient_left = func.extract_transient_info('green_left', dFF0, pi_events, plot_zscore=0, plot=1)
    r_right = func.visualize_trial_by_trial(transient_right, dFF0, 'green_right', session_label=signal_dir[-23:-7],
                                            plot=0, save=0, save_path=fig_export_dir, left_or_right='right')
    r_left = func.visualize_trial_by_trial(transient_left, dFF0, 'green_left', session_label=signal_dir[-23:-7],
                                           plot=0, save=0, save_path=fig_export_dir, left_or_right='left')
